...
public class CardClick extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("users").child(username).child(category).child("task");
                    ...
                    reference.child(id).setValue(model).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(CardClick.this, "Task has been inserted succesfully", Toast.LENGTH_SHORT).show();
                                loader.dismiss();
                            }
                            else
                            {
                                String error =task.getException().toString();
                                Toast.makeText(CardClick.this, "Failed"+error, Toast.LENGTH_SHORT).show();
                                loader.dismiss();
                            }
                        }
                    });
            ...
            public void onClick(View v) {
                ...
                reference.child(key).setValue(model).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful())
                        {
                            Toast.makeText(CardClick.this, "Data has been u[dated sucessfully", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            String ERR = task.getException().toString();
                            Toast.makeText(CardClick.this, "update field "+ERR, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            ...
            public void onClick(View v) {
                reference.child(key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful())
                        {
                            Toast.makeText(CardClick.this, "Task deleted succesfully", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            String err =task.getException().toString();
                            Toast.makeText(CardClick.this, "Failed to delete task"+err, Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                dialog.dismiss();
